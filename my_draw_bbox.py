...
parser.add_argument("--data_path", type=str, default="./screenshots/data.json")
parser.add_argument("--img_path", type=str, default="./screenshots/images/")
parser.add_argument("--image_num", type=str, default="11")
...
def main(DATA_PATH, IMG_PATH, IMG_NUM):
    ...
    for i in range(len(bboxes)):
        ...
        ymin = int(head_bboxes[1])
        xmax = int(head_bboxes[2])
        ymax = int(head_bboxes[3])
        cv2.rectangle(image, (xmax, ymax), (xmin, ymin), (0, 255, 0), 1)
