...
class GazeLLE(nn.Module):
    ...
    #makes binary map on the feature grid where the head box is 1 and elsewhere is 0
    #head_map_embeddings multiplies this map by a learned head_token embedding, producing a per-location modulation
    #x = x + head_map_embeddings injects a "where the head is" into the feature map
...
#build backbone + GazeLLE with or without in/out head
